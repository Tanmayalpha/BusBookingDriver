...
final Uri getDeliveryBoyCashCollection = Uri.parse(baseUrl +'get_delivery_boy_cash_collection');
...
final Uri getBusDetailsApi = Uri.parse(baseUrl + 'get_bus_details');
...
const String DEL_TYPE = 'delivery_type';
